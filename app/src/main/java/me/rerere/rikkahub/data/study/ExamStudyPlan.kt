...
object ExamStudyPlan {
    ...
    val monthlyPlans = listOf(
        MonthlyStudyPlan(
            ...
            "稳启动：7月就开始背诵和章节闭环",
            listOf(
                "章节/课时：法理 $legalTheoryChapterCount 章找回；刑法第 1 章已看完，7 月转章节题、错题、框架图/思维导图和第一轮关键词背诵，第 2 章等第 1 章闭环痕迹稳定后再开；民法第 1 章从零启动，优先连续听完并画入口框架，闭环后再做章节题；宪法/法制史第 1-2 章入口",
                "背诵：法理 13 章第一轮目录树和关键词走完；刑民只对闭环章节做第一轮关键词；宪法/法制史只背入口关键词；每天至少 20-30 分钟，不等听完全部课",
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-15", "刑法2第1切片 + 民法2入口", "刑法学第 2 章：听众合法硕刑法课程 60-90 分钟，作为第 1 个切片，听完写 3-5 个关键词和 1 个不懂点", "民法第 2 章：听众合法硕民法课程 30-45 分钟，只抓入口概念", "背诵：刑法第 1 章第一轮关键词，能复述结构即可", "画刑法第 1-2 章连接框架", dailyLongSentenceTaskTitle, "饭后配音乐原地踏步 8 分钟，脚踝和膝盖轻活动"),
        daily("2026-07-16", "民法2第1切片 + 宪法1入口", "民法第 2 章：听众合法硕民法课程 60-90 分钟，作为第 1 个切片，课后只留关键词和不懂点", "宪法学第 1 章：听众合法硕宪法课程 30-45 分钟，只抓总入口和核心概念", "背诵：民法第 1 章第一轮关键词", "画宪法第 1 章入口框架", dailyVocabularyTaskTitle, "饭后洗漱 + 开窗站一会儿，等困劲过去再整理框架"),
        daily("2026-07-17", "法理9 + 法制史1入口", "法理学第 9 章：用考试分析和错题本回看、框架整理、第一轮关键词背诵", "法制史第 1 章：听众合法硕法制史课程 30-45 分钟，抓朝代线索入口", "背诵：法理第 1-8 章第二次滚动，只背目录和关键词", "整理法制史时间线入口图", "英语阅读预备：从真题阅读里摘 1 句长难句拆解", "天气凉快就散步 15-20 分钟，天气热就手势舞一首歌"),
        daily("2026-07-18", "刑法2第2切片 + 本周回炉", "刑法学第 2 章：听众合法硕刑法课程 60-90 分钟，作为第 2 个切片，课后只留关键词和不懂点", "民法第 2 章：回看第 1 切片关键词 15 分钟，不做题", "背诵：刑法第 1 章第一轮关键词", "错题：只回看刑法第 1 章已闭环错题 5-10 题，未闭环不刷", dailyLongSentenceTaskTitle, "饭后低阻力整理错题清单；中间穿插转肩转腰 3 分钟"),
        daily("2026-07-19", "民法2第2切片 + 刑法2框架", "民法第 2 章：听众合法硕民法课程 60-90 分钟，作为第 2 个切片，课后只留关键词和不懂点", "刑法第 2 章：整理听课小框架和不懂点，不做整章题", "背诵：民法第 1 章第一轮关键词", "画民法第 1-2 章小框架", "英语：单词 120 个；状态好做真题阅读 1 小段定位", "第八套广播体操选 3 节，不追求标准，只让身体顺一点"),
        daily("2026-07-20", "法理11 + 宪法法制史背诵", "法理学第 11 章：用考试分析和错题本回看、框架整理、第一轮关键词背诵", "宪法第 1 章：关键词背诵 15 分钟，只背入口概念", "法制史第 1 章：时间线背诵 15 分钟", "整理宪法/法制史入门框架", "英语：田静《句句真研》或真题阅读句子 1 句长难句", "饭后不做硬背诵，先听音乐慢走或寝室轻舞 10 分钟"),
        daily("2026-07-21", "周复盘：五科第一次同屏", "今天作为周复盘/缓冲，不新增大章节", "回看刑法第 1 章错题；刑法第 2 章只统计已听分钟数和未闭环切片", "回看民法第 1 章错题；民法第 2 章只统计已听分钟数和未闭环切片", "法理第 1-11 章口头背目录，列出最卡的 5 章", "整理已闭环范围里最常错 10 个点", "休息；朋友有空就轻打羽毛球 20-30 分钟，没有就开窗站 + 手势舞"),
        daily("2026-07-22", "法理12 + 刑法3第1切片", "法理学第 12 章：用考试分析和错题本回看、框架整理、第一轮关键词背诵", "刑法学第 3 章：听众合法硕刑法课程 60-90 分钟，作为第 1 个切片，听完写 3-5 个关键词和 1 个不懂点", "背诵：法理第 9-11 章第一轮目录和关键词", "画法理第 9-12 章思维导图", dailyLongSentenceTaskTitle, "饭后放音乐做肩颈和腰部轻活动 8-10 分钟"),
        ...
        daily("2026-07-24", "民法3第1切片 + 法理13", "民法第 3 章：听众合法硕民法课程 60-90 分钟，作为第 1 个切片，听完写 3-5 个关键词", "法理学第 13 章：用考试分析和错题本回看、框架整理、第一轮关键词背诵", "民法第 2 章：只复述已听关键词，未确认整章闭环前不算第一轮背诵", "整理民法第 1-3 章目录图", dailyLongSentenceTaskTitle, "天气舒服就散步 15-20 分钟；天气热就第八套广播体操选段"),
        ...
        daily("2026-07-27", "民法3回炉 + 民法4可选入口", "民法第 3 章：回看听课框架，标出混淆点和未闭环切片", "民法第 4 章：只有状态好才听众合法硕民法课程 45-60 分钟作为入口；状态一般就不新开", "民法第 2-3 章：只复述已听关键词，未闭环章节不算第一轮", "画民法第 3-4 章框架草图，资料整理不超过 20 分钟", "英语阅读预备：真题阅读 1 小段，口头复述译文", "饭后听音乐慢走；热天就在寝室原地踏步"),
        ...
        daily("2026-07-30", "民法未闭环补切片 + 宪法2入口", "民法：按实际进度补一个未闭环切片 60-90 分钟；如果第 4 章已开，就作为第 2 个切片，否则补第 2-3 章", "宪法学第 2 章：听众合法硕宪法课程 30-45 分钟，只抓入口，不做题", "刑法第 3-4 章：只复述已听关键词，未闭环章节不算第一轮", "画宪法第 1-2 章框架", "英语：单词 120 个；整理 8 月阅读真题材料入口", "饭后音乐轻活动 10 分钟：手势舞、转肩转腰或原地踏步任选"),
