...
object ExamStudyPlan {
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-10", "补昨日欠账第1段 + 刑法2入口", "昨日法理第 1-3 章欠账：正式背诵 20-25 分钟，只完成目录树和最卡关键词，不要求一次背完", "昨日刑法第 1 章框架图欠账：先画犯罪论入口与构成要件主干 20-25 分钟，今天只完成上半张", "刑法学第 2 章：听众合法硕刑法课程 60-75 分钟，作为第 1 个主块，课后只留 3-5 个关键词和 1 个不懂点", "法理学第 5 章降为 15 分钟入口复述，不与欠账抢时间", "英语：不背单词 120 个可拆到早中晚，状态差就只保底", "第八套广播体操选 2-3 节，晚上不因欠账继续熬夜"),
        daily("2026-07-11", "补昨日欠账第2段 + 刑法2推进", "昨日法理第 1-3 章欠账：再背 20-25 分钟，重点攻昨天仍卡住的目录和关键词", "昨日刑法第 1 章框架图欠账：补选择题陷阱、案例分析入口和错因，20-30 分钟内合成完整一张", "刑法学第 2 章：听众合法硕刑法课程 60-75 分钟，作为第 2 个主块，不刷整章题", "法理学第 6 章只做 20 分钟目录树入口，未完成部分放到下周回收", dailyLongSentenceTaskTitle, "饭后洗漱 + 手势舞一首歌，热天不强迫出门"),
        daily("2026-07-12", "欠账验收 + 本周收口", "法理第 1-3 章欠账验收：闭卷口头复述 15-20 分钟，仍不会的点写入下周回收清单，不继续硬磨", "刑法第 1 章框架图验收：看图复述犯罪论主干 10-15 分钟，只修影响理解的缺口", "刑法学第 2 章：听众合法硕刑法课程 60 分钟；如果疲劳，只整理已有关键词和不懂点", "法理学第 7 章改为 15-20 分钟轻入口，不追求当日完整背诵", "整理一页下周回收清单：法理 1-3 残留点、法理 5-7 未完成量、刑法 1 框架缺口", "如果朋友有空，轻打羽毛球 20-30 分钟；没有就做第八套广播体操半套"),
        daily("2026-07-13", "刑法1收口 + 欠账轻回收", "刑法第 1 章：整章章节题补完剩余约 20-25 道；错题按概念不清、法条不熟、题干没读懂、选项陷阱归类", "从 7 月 12 日回收清单只挑 2 个法理第 1-3 章残留点复述 15 分钟，今天不再整章重背", "刑法第 2 章：补本章小框架；如果整章已听完，再安排后续章节题", "背诵：刑法第 1 章第一轮关键词 15 分钟；法理第 8 章入口 20 分钟", "英语阅读预备：真题阅读 1 小段，只做题干定位和译文复述", "饭后低阻力整理桌面 10 分钟"),
