...
object ExamStudyPlan {
    ...
    val subjectExecutionReference = """
        ...
        - 英语材料主线：不背单词固定 120 个；长难句用田静《句句真研》/颉斌斌 66 句/真题阅读句子三选一；语法单独按知识点清单复盘，不能把“拆了一句长难句”冒充系统语法；阅读用历年真题解析书或正版真题册；作文用石雷鹏或王江涛择一；翻译可用唐静或已购课程；小三门明确指完形、新题型、翻译，优先真题解析和短方法课，不买大量新资料。
        - 英语题型流程：阅读按 $englishReadingPassCount 层走——一刷精读（题干定位、原文证据、错因、摘句）、二刷单篇限时、三刷错题和证据复述；7 月每周至少 3 篇阅读/精读、2 次语法或长难句、1 次复盘；8 月保持 3-4 篇阅读并开始限时；9 月起完形、新题型、翻译三类每周各至少 1 个小块，不再轮换到某类消失；10 月起小作文和大作文每周各 1 次（写作—批改—重写/背诵）；11-12 月分别做历年真题整套与模拟整套，次日复盘，不能把一套卷重复计成两套。
    ...
    val monthlyPlans = listOf(
        ...
        MonthlyStudyPlan("2026-08", "刑法收口后启动民法", listOf(
            ...
            "英语：120 个单词不断线；每周 3-4 篇真题阅读，其中至少 1 篇开始单篇限时；2 次语法/长难句、1 次翻译和 1 次错因复盘。阅读留下题干定位、原文证据、错因和摘句",
        ...
        MonthlyStudyPlan("2026-09", "新课收口与背诵输出并行", listOf(
            ...
            "英语：每周 3-4 篇真题阅读，其中至少 2 篇单篇限时；完形、新题型、翻译每周各至少 1 个小块，单词继续滚动，并启动小作文/大作文审题与提纲各 1 次",
        ...
        MonthlyStudyPlan("2026-10", "第二轮规范表述与真题化", listOf(
            ...
            "英语：每周 3 篇单篇限时阅读并精复盘；完形、新题型、翻译每周各 1 次；作文每周 1 次小作文 + 1 次大作文，必须完成审题—写作—批改—重写/背诵，月底形成稳定模板而非照抄范文",
    ...
    val julyWeeks = listOf(
        ...
        WeeklyStudyPlan("2026-07-w4", "刑法第 8 章起顺序推进 + 法理 2 + 英语阅读起步", "2026-07-20 至 2026-07-26", listOf(
            ...
            "英语：每天 120 个单词；3 次真题阅读精读、2 次语法/长难句、1 次翻译，周六完成本月第一篇不计时完整阅读并写题干定位、证据和错因",
    ...
    val postJulyWeeks = listOf(
        WeeklyStudyPlan("2026-08-w1", "刑法收口与民法条件启动", "2026-08-01 至 2026-08-07", listOf(
            ...
            "英语：120 个单词每日不断线，3 篇真题阅读精读、2 次语法/长难句、1 次翻译、1 次错因复盘",
            "政治：不启动；周日完整休息",
        )),
        ...
        WeeklyStudyPlan("2026-08-w4", "8 月收口与 9 月重排", "2026-08-21 至 2026-08-31", listOf(
            ...
            "背诵：法理第 1-6 章第一轮验收，刑法已闭环章抽背 2 次；英语每周 3-4 篇阅读、2 次语法/长难句、1 次翻译和 1 次周复盘",
        ...
        WeeklyStudyPlan("2026-09-w1", "顺序新课推进与已学回炉", "2026-09-01 至 2026-09-07", listOf(
            ...
            "英语：3 篇阅读，其中 1 篇单篇限时；语法/长难句 2 次，完形、新题型、翻译各 1 次入门；政治暂不启动",
        )),
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-17", "3.5 小时增长日：刑法3-7配套题 + 连接框架 + 英语", "确认第 3-7 章课程全部结束后，完成第 3-7 章合并题（听课配套题）第一大块 80 分钟并标主错因；未结束就补第 7 章课程", "正式连接框架图完成主干、章节连接和易混点 40 分钟", "法理第 1 章第一轮闭卷回忆 30 分钟", dailyVocabularyTaskTitle, dailyLongSentenceTaskTitle, "不熬夜硬清；独立额外题源与错题回炉进入下周题源账本"),
        ...
        daily("2026-07-21", "刑法课程 + 配套题层 + 英语阅读", "继续当前听众合法硕刑法课程 90 分钟，不跨章跳跃；课后随手整理包含在课程内", "最近已闭环章的听课配套题继续 30 分钟，记录本套题完成量和主错因；未闭环就把本块改为课程续段", "法理第 2 章第一轮闭卷回忆 25 分钟", dailyVocabularyTaskTitle, dailyEnglishReadingTaskTitle, "整理本周卡点清单 10 分钟即可", "天气和身体合适时轻打羽毛球 20-30 分钟，不作为硬任务"),
        daily("2026-07-22", "刑法课程 + 额外题源 + 英语长难句", "按当前课程账本继续听众合法硕刑法课程 90 分钟，记录实际听课分钟", "法理第 2 章第一轮正式背诵 25 分钟，完成目录树和关键词复述", "从最近已经完成配套题的闭环章启动独立额外题源 30 分钟；不得把同一套题重复记为第二套", dailyVocabularyTaskTitle, dailyLongSentenceTaskTitle, "广播体操 10 分钟"),
        ...
        daily("2026-07-24", "刑法课程 + 正式框架 + 英语长难句", "继续当前刑法课程主块 90 分钟，按实际分钟记录", "完成最近闭环章正式框架图 30 分钟；题目尚未完成时先清题，不用框架替代刷题", "法理第 2 章第一轮正式背诵 25 分钟，不熬夜", dailyVocabularyTaskTitle, dailyLongSentenceTaskTitle, "按时结束"),
    ...
    private fun generatedFallbackPlan(date: LocalDate): DailyStudyPlan? {
        ...
        val english = when (date.monthValue) {
            8 -> "英语：今日动作：${defaultEnglishCoreTask(date)}；本周完成阅读精读/限时、语法长难句、翻译和错因复盘"
    ...
    fun dynamicSchedulePrompt(
        ...
        return buildString {
            ...
            appendLine("- 非完整休息日固定保留 $dailyVocabularyTaskTitle，并且从 2026-07-13 起必须再安排英语主训练块；7-8 月以阅读、语法/长难句为主，9 月起完形、新题型、翻译每周各至少出现一次，10 月起大小作文都要写作—批改—重写，11-12 月按计划做整卷。不能连续只排单词。如果日期是 $currentWeekRestDate 或用户明确选择当天完整休息，当天不安排任何学习任务，英语也不补。")
        ...
        return DailyStudyPlan(
            ...
            tasks = normalizedTasks.map { task ->
                planTask(
                    title = task,
                    kind = when {
                        task.contains("英语") || task.contains("单词") || task.contains("长难句") ||
    ...
    private fun defaultEnglishCoreTask(date: LocalDate): String = when {
        ...
        date.monthValue == 8 -> when (date.dayOfWeek) {
            ...
            DayOfWeek.TUESDAY -> "英语语法清单 + 长难句：完成 1 个语法点、拆 1 句主干并复述译文"
            DayOfWeek.THURSDAY -> "英语翻译：真题 2 句，完成断句、语法还原、译文和重写"
            DayOfWeek.SATURDAY, DayOfWeek.SUNDAY -> "英语周复盘：复盘阅读错因并回测本周第 2 个语法/长难句卡点"
        }
        date.monthValue == 9 -> when (date.dayOfWeek) {
            DayOfWeek.MONDAY -> dailyEnglishReadingTaskTitle
            DayOfWeek.TUESDAY -> "英语真题阅读 + 语法长难句：完成 1 篇阅读证据链，并复盘其中 1 个语法点/长难句"
