...
object ExamStudyPlan {
    ...
    val monthlyPlans = listOf(
        MonthlyStudyPlan(
            ...
            "稳启动：7月就开始背诵和章节闭环",
            listOf(
                "章节/课时：法理 $legalTheoryChapterCount 章找回；刑法第 1 章闭环、第 2-3 章切片、第 4 章可选入口；民法第 1 章闭环、第 2-3 章切片、第 4 章可选入口；宪法/法制史第 1-2 章入口",
    ...
    val julyWeeks = listOf(
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法第 1 章：本周优先连续完成 2-3 个众合法硕听课切片，先累计约 3 小时主块；每个切片后写 3-5 个关键词、1 个不懂点或 1 张小框架，不做整章章节题",
                "法理第 1-3 章：只用考试分析/错题本回看目录树和关键词，不重听大课；每天只验收 1 个小块",
                "民法第 1 章：等刑法第 1 章至少完成约 3 小时切片后再开 30-45 分钟众合法硕课程入口，写主体和民事法律关系关键词，不急着做题",
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-07", "第一周复盘 + 刑法轻补", "刑法学第 1 章：听众合法硕刑法课程 45-60 分钟，只补一个轻切片或回看已听切片，不单独安排题目", "统计刑法第 1 章本周已听分钟数、已学范围和未闭环切片", "回看法理第 1-3 章错题和目录背诵卡点", "回看民法第 1 章入口关键词，补 5 个关键词", "英语阅读预备：从真题阅读里摘 1 句长难句，只做主干、修饰和译文复述", "好好吃一顿饭；天气不热就散步 20 分钟，热就改寝室音乐轻舞 1 首歌"),
        daily("2026-07-08", "法理5 + 刑法1第4切片", "法理学第 5 章：用考试分析和错题本回看目录、框架、关键词，完成第一轮背诵痕迹", "刑法学第 1 章：听众合法硕刑法课程 60-90 分钟，作为第 4 个切片，听完写构成要件小框架", "背诵：法理第 1-4 章滚动 15 分钟，只背目录和关键词", "画法理第 1-5 章小总图，资料整理不超过 20 分钟", dailyVocabularyTaskTitle, "饭后只做手势舞一首歌或整理桌面，不开新课"),
        daily("2026-07-09", "民法1连续主块启动", "民法第 1 章：听众合法硕民法课程 75-90 分钟，作为民法连续单元第 1 个主块，抓主体和民事法律关系入口", "民法第 1 章：课后只留 3-5 个关键词、1 个不懂点和一个主体/法律关系小框架，不急着做整章题", "法理学第 6 章：用考试分析做目录树第一轮背诵，并补 3 个不稳关键词", "刑法第 1 章：只复述已听关键词 10 分钟，保温但不新开大块", dailyLongSentenceTaskTitle, "饭后开窗站一会儿，配音乐转肩、转腰、脚踝绕圈 8-10 分钟"),
        daily("2026-07-10", "法理7 + 刑法1第5切片", "法理学第 7 章：错题回看并背关键词，验收为能口头说出本章目录", "刑法学第 1 章：听众合法硕刑法课程 60-90 分钟，作为第 5 个切片，补齐犯罪论入口笔记", "背诵：法理第 5-6 章第一轮目录和关键词", "整理刑法第 1 章犯罪论总框架，暂不做整章题", "英语：不背单词 120 个，状态好再摘 1 个真题阅读小段做定位", "第八套广播体操选 2-3 节，动作小一点，只做身体润滑"),
        daily("2026-07-11", "民法1连续主块继续", "民法第 1 章：听众合法硕民法课程 75-90 分钟，作为民法连续单元第 2 个主块，课后只留关键词和小框架", "民法第 1 章：累计约 3 小时后再判断是否需要第 3 个切片；整章未闭环前不做整章章节题", "刑法学第 1 章：只回看已听切片关键词 15 分钟，列出整章章节题前还缺哪些知识点", "背诵：民法第 1 章关键词 15 分钟，只背入口概念", dailyLongSentenceTaskTitle, "饭后洗漱 + 手势舞一首歌，热天不强迫出门"),
        ...
        daily("2026-07-14", "轻量缓冲日", "今天不新增硬章节；只做缓冲、复盘和身体恢复", "法理第 1-7 章二次背诵 20 分钟，只背目录树", "刑法第 1 章错题/切片清单回看，确认 6 小时课程还缺哪些切片", "英语：单词 120 个拆成 6 组，状态差可拆到早中晚", "第八套广播体操半套或手势舞一首歌，饭后不补课"),
    ...
    fun todaySchedule(date: LocalDate = LocalDate.now()): List<StudyScheduleBlock> {
        ...
        return buildList {
            ...
            add(StudyScheduleBlock("10:00-11:40", if (hasLesson) "连续主块" else "主线推进", mainInput))
