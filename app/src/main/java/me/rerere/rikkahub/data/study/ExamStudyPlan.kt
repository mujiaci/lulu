...
object ExamStudyPlan {
    ...
    val studyHabitReference = """
        ...
        - 法硕专业课必须按倍数估算：听课一轮只是第一层成本，后面还有做题、错题总结、框架和三轮背诵。正常学习日不能只排“听一小段课”；除身体恢复日外，至少要有 60-90 分钟主块、30-45 分钟题目/错题块、15-25 分钟背诵或框架封口。
    ...
    val monthlyPlans = listOf(
        MonthlyStudyPlan(
            "2026-07",
            "重建学习系统：刑民按课时切片开局，法理找回，开始第一轮背诵和错题闭环",
            listOf(
                "确认五科章节账本和课时账本：法理学 13 章、刑法学 25 章/5888 分钟、民法 21 章/5993 分钟、宪法学 7 章/2553 分钟、法制史 7 章/3402 分钟",
                "本月目标不是追章节数，而是把学习机器跑起来：听课切片、章节题、错题、框架、第一轮背诵每天都要留下痕迹",
                "法理学已经听课和做题一遍，本月重点做 13 章目录回忆、错题回看、第一轮背诵找回和框架补洞",
                "刑法学优先：第 1 章 6 小时课程必须拆完并配套题目/错题/框架，再推进第 2-4 章；状态好可摸到第 5 章入口",
                "民法作为第二主线：先稳住第 1-3/4 章听课切片和基础题，不和刑法抢同一黄金时段",
                "宪法学、法制史本月只做入门框架和少量题，目标是建立科目感觉，不抢刑民主力时间",
                "不背单词约 $vocabularyBacklog 个复习池按 20 个一组滚动，每天固定 $dailyVocabularyTaskTitle；$dailyLongSentenceTaskTitle",
                "每周至少 1 天缓冲，但缓冲日也要做最小闭环：单词、错题 5-10 题、目录背 10-15 分钟或散步",
            ),
        ),
        MonthlyStudyPlan(
            "2026-08",
            "一轮主体推进：刑民听课和题感成型，综合课入门，第一轮背诵不断线",
            listOf(
                "续接 7 月实际进度，刑法、民法优先完成尽可能多的一轮听课切片，但每章必须带章节题、错题和框架，不做纯听课流水账",
                "刑法目标按周滚动推进到中后段；民法推进到物权/债法主体区域。若落后，先保刑民核心章节闭环，不用硬追数字",
                "宪法学、法制史进入稳定入门：每周至少 2-3 次小块听课/题目/框架，避免 9 月突然开荒",
                "第一轮背诵成为日常：每天至少 20-30 分钟目录式回忆或关键词输出，法理优先完整走完一轮",
    ...
    val julyWeeks = listOf(
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法第 1 章题目：本周累计做 15-25 题，错题必须写错因，不追求题量漂亮",
                "法理第 1-3 章：错题回看、目录式背诵和框架补洞，不重复从零听课",
                "民法第 1 章只做入口：30-60 分钟听课 + 5-8 题，作为第二主线预热",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法第 1 章必须收口：6 小时课程、章节题、错题、犯罪论总框架和第一轮关键词背诵都要留下痕迹",
                "刑法第 2 章启动：累计 2-3 个听课切片，配 10-15 题，不要求一周内完美吃透",
                "民法第 1 章推进到收口：累计 2-3 个切片，配 10-15 题和入口框架",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "本周开始固定错题本：刑民每科至少整理 10 个错因，不只标答案",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法第 3-4 章、民法第 3-4 章按课时切片推进，能闭环的章节当天补题和框架",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法、民法按实际听课分钟数收口：优先补完第 4 章附近的未闭环切片，状态好再开第 5 章入口",
                "宪法第 2 章、法制史第 2 章补入口和框架",
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-03", "病后慢启动：保底 + 可加码", "起床后先吃清淡、喝热水、洗漱，整理桌面 10 分钟；今天不追上午时长", "法理学第 2 章：回看错题和目录框架 30-40 分钟，不背完整表述、不补难题", "刑法学第 1 章：听众合法硕刑法课程 30-40 分钟，作为 6 小时课程的恢复日入口切片，听完写 3 个关键词和 1 个不懂点", "加码任务：如果晚上身体还可以，再做刑法第 1 章 5 题并写错因；不舒服就只保留保底", "不背单词 120 个（6 组）：拆成 3 次完成，每次 2 组，中间必须离桌休息", "饭后散步或慢走 15-20 分钟，等困劲过去再回桌面", "睡前 10 分钟写明天第一步，23:30 前结束学习入口"),
        daily("2026-07-04", "恢复到正常最小强度：刑法1主块", "上午先观察身体状态，热水、清淡早饭、整理桌面 10 分钟后再开始", "刑法学第 1 章：听众合法硕刑法课程 75-90 分钟，作为第 2 个切片，抓犯罪论总入口和构成要件", "刑法学第 1 章：做 8-10 题并写错因，至少分出概念不清、题干没读懂、选项陷阱", "法理学第 2 章：用 20 分钟口头复述框架，卡住就看目录提示", dailyVocabularyTaskTitle, "饭后散步 15-20 分钟；晚上只做错题封口和提前睡"),
        daily("2026-07-05", "刑法1继续 + 民法1入口", "刑法学第 1 章：听众合法硕刑法课程 75-90 分钟，作为第 3 个切片，听完补构成要件小框架", "刑法学第 1 章：回看昨天错题 5 题，补 3 个关键词", "民法第 1 章：听众合法硕民法课程 30-45 分钟，抓主体和民事法律关系入口", "民法第 1 章：只做 5-8 题建立题感", dailyVocabularyTaskTitle, "散步 15-20 分钟"),
        daily("2026-07-06", "刑法1题目 + 法理回背", "刑法学第 1 章：听众合法硕刑法课程 60-75 分钟，作为第 4 个切片，听完补 5 题并标错因", "刑法学第 1 章：整理一页犯罪论入口框架，不抄书，只写结构和易混点", "法理第 1-3 章：目录式回背 20 分钟", "背诵：法理第 2-3 章关键词，不追求一口气背完", dailyVocabularyTaskTitle, "散步或拉伸 20 分钟"),
        daily("2026-07-07", "第一周复盘与容错", dailyVocabularyTaskTitle, "统计刑法第 1 章本周已听分钟数、已做题数、错题原因", "回看法理第 1-3 章错题和目录背诵卡点", "回看民法第 1 章入口题，补 5 个关键词", "补一个本周漏掉的小任务，只补最小一块", "好好吃一顿饭，散步 20 分钟"),
    ...
    fun todaySchedule(date: LocalDate = LocalDate.now()): List<StudyScheduleBlock> {
        ...
        if (date == LocalDate.of(2026, 7, 3)) {
            return listOf(
                ...
                StudyScheduleBlock("19:10-19:35", "刑法加码", "如果身体还可以，做刑法第 1 章 5 题并写错因；如果肚子还难受，这一块直接取消。"),
    ...
    fun dynamicSchedulePrompt(
        ...
        return buildString {
            ...
            appendLine("- 正常学习日不能只排一个短听课入口：至少安排 60-90 分钟专业课主块、30-45 分钟题目/错题块、15-25 分钟背诵或框架封口。")
