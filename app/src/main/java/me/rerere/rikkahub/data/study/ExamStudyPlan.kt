...
object ExamStudyPlan {
    ...
    val studyHabitReference = """
        ...
        - 负荷参考：真正不适时恢复约 $recoveryStudyMinutes 分钟；本周健康日约 210 分钟；7 月 20 日周约 270 分钟；7 月 27 日周约 330 分钟；8 月 3 日周约 360 分钟；8 月 10 日周约 390 分钟；8 月 17 日至 9 月 14 日约 420 分钟；政治和多层刷题启动后，9 月 15 日起约 450 分钟，10-11 月约 510 分钟，12 月前两周约 480 分钟。新增题源允许提高总时长，但仍按周爬坡；每周日休息，任何一周完成率或睡眠崩掉就停在原档，不硬升。
        ...
        - 专业课听课配套题一套按约 $chapterPracticeQuestionsPerSet 道估算。10-15 道只能算启动、回看或恢复日小块；正常闭环先在 2-3 天内补完整套并整理错因，再进入至少一套独立额外题源，不能把第一套题写成全部刷题完成。
        ...
        - 英语不再单独安排长难句训练，也不把“摘一句长难句”当作完成痕迹；把有限时间直接用于英语一完整题型链。当前能力画像记录为：阅读单篇 12 分钟、5 题错 2 题（3/5）；完形单篇 10 分钟、20 题错 14 题（6/20）。这不是把计划锁死在两种题型，而是用来判断薄弱项：完形当前正确率明显偏低，后续增加完形逻辑、词义辨析和错因复盘频次，同时保持语法、阅读、新题型、翻译、大小作文和整卷训练不断线。
    ...
    val monthlyPlans = listOf(
        ...
        MonthlyStudyPlan("2026-09", "新课收口与背诵输出并行", listOf(
            ...
            "9 月 15-30 日：力争收口常规新课；法理第 7-13 章完成第一轮，已通过第一轮的早期章节启动第二轮规范表述；配套题、额外题源和错题多轮继续补齐，每周至少 2 次主观题闭卷输出并订正",
            ...
            "负荷：9 月 1-14 日约 420 分钟/日，9 月 15 日政治与多层刷题启动后约 450 分钟/日；新增量计入总时长，不从英语、背诵或休息日偷时间",
            "分数验收：9 月末做两张专业课分科诊断卷，先达到每张 100-105 分；低于 100 分必须按选择题知识漏洞、主观题表述遗漏分别回炉",
        )),
        MonthlyStudyPlan("2026-10", "第二轮规范表述与真题化", listOf(
            "五科第二轮规范表述全覆盖；只有第一轮验收通过的章节才能进入二轮，未通过章节回到目录树和关键词，不开常规新课",
            ...
            "负荷：专业课额外题源、真题二刷、英语作文重写和政治一刷均为新增量，10-11 月健康日目标约 510 分钟，周日仍完整休息",
    ...
    val julyWeeks = listOf(
        ...
        WeeklyStudyPlan("2026-07-w3", "刑法 2-7 章闭环 + 法理 1 背诵 + 英语双线", "2026-07-13 至 2026-07-19", listOf(
            ...
            "刑法：7 月 13 日先集中完成第 2 章独立题组（听课配套题）和正式框架图；随后按顺序完成第 5-7 章课程；第 3-7 章听完后完成第 3-7 章合并题（听课配套题）。本周建立额外题源账本，未塞进 3.5 小时日预算的第二套题明确顺延到下周，不冒充已完成",
        ...
        WeeklyStudyPlan("2026-07-w4", "刑法第 8 章起顺序推进 + 法理 2 + 英语阅读起步", "2026-07-20 至 2026-07-26", listOf(
            ...
            "刑法：先验收第 2 章和第 3-7 章组合闭环，再从第 8 章起推进课程；本周至少安排 1 个配套题块、1 个独立额外题源块、1 个错题隔日/7 日回炉块和正式框架图，不跨章跳跃",
    ...
    val postJulyWeeks = listOf(
        ...
        WeeklyStudyPlan("2026-09-w3", "新课尾巴、背诵与政治启动", "2026-09-15 至 2026-09-21", listOf(
            "负荷：政治与多层刷题加入后约 7.5 小时/日；新增量直接计入总时长，周日仍休息",
        ...
        WeeklyStudyPlan("2026-10-w1", "第二轮：刑法民法", "2026-10-01 至 2026-10-07", listOf(
            "负荷：健康日约 8.5 小时，新增额外题源、真题二刷、作文重写和政治题量已计入；周日完整休息",
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-17", "3.5 小时增长日：刑法3-7配套题 + 连接框架 + 英语真题", "确认第 3-7 章课程全部结束后，完成第 3-7 章合并题（听课配套题）第一大块 80 分钟并标主错因；未结束就补第 7 章课程", "正式连接框架图完成主干、章节连接和易混点 40 分钟", "法理第 1 章第一轮闭卷回忆 30 分钟", dailyVocabularyTaskTitle, dailyEnglishReadingTaskTitle, "不熬夜硬清；独立额外题源与错题回炉进入下周题源账本"),
        daily("2026-07-18", "3.5 小时起步：配套题收口 + 法理验收 + 英语周复盘", "第 3-7 章合并题（听课配套题）继续 75 分钟并整理主错因；若课程未收口则继续第 7 章，不提前刷题", "补齐第 3-7 章正式连接框架图 35 分钟", "法理第 1 章第一轮闭卷验收 30 分钟：口头复述后写下 3 个最不稳点", dailyVocabularyTaskTitle, dailyEnglishReviewTaskTitle, "广播体操 10 分钟，23:00 后不再学习"),
        restDaily("2026-07-19", "周日完整休息/缓冲日：不安排学习任务"),
        daily("2026-07-20", "刑法8章课程 + 法理2入口 + 英语真题", "确认第 2 章和第 3-7 章闭环已完成后，听众合法硕刑法第 8 章课程 90-100 分钟；否则补最近闭环", "法理第 2 章第一轮闭卷背诵 25 分钟", dailyVocabularyTaskTitle, dailyEnglishReadingTaskTitle, "晚上按时结束"),
        daily("2026-07-21", "刑法课程 + 配套题层 + 英语阅读", "继续当前听众合法硕刑法课程 90 分钟，不跨章跳跃；课后随手整理包含在课程内", "最近已闭环章的听课配套题继续 30 分钟，记录本套题完成量和主错因；未闭环就把本块改为课程续段", "法理第 2 章第一轮闭卷回忆 25 分钟", dailyVocabularyTaskTitle, dailyEnglishReadingTaskTitle, "整理本周卡点清单 10 分钟即可", "午后和晚间可各做半套广播体操；累时只保留一次，不用羽毛球加重恢复负担"),
        daily("2026-07-22", "刑法课程 + 额外题源 + 英语真题完形", "按当前课程账本继续听众合法硕刑法课程 90 分钟，记录实际听课分钟", "法理第 2 章第一轮正式背诵 25 分钟，完成目录树和关键词复述", "从最近已经完成配套题的闭环章启动独立额外题源 30 分钟；不得把同一套题重复记为第二套", dailyVocabularyTaskTitle, dailyEnglishClozeTaskTitle, "广播体操 10 分钟"),
        daily("2026-07-23", "刑法课程 + 错题回炉 + 英语阅读", "继续当前听众合法硕刑法课程 90 分钟，上一章未结束时不切换", "回炉最近配套题/额外题源错题 30 分钟：隔日重做、记录是否再次出错和唯一主错因", "法理第 2 章第一轮闭卷回背 25 分钟", dailyVocabularyTaskTitle, dailyEnglishReadingTaskTitle, "饭后轻活动"),
        daily("2026-07-24", "刑法课程 + 正式框架 + 英语真题完形", "继续当前刑法课程主块 90 分钟，按实际分钟记录", "完成最近闭环章正式框架图 30 分钟；题目尚未完成时先清题，不用框架替代刷题", "法理第 2 章第一轮正式背诵 25 分钟，不熬夜", dailyVocabularyTaskTitle, dailyEnglishClozeTaskTitle, "按时结束"),
        daily("2026-07-25", "刑法阶段复盘 + 英语完整阅读", "按课程账本补最近未完成的听课切片 90 分钟", "完成一个正式闭环验收：题组、主错因或框架图，30 分钟", "法理第 2 章闭卷验收 25 分钟", dailyVocabularyTaskTitle, "英语真题阅读完整篇：记录限时、得分、题干定位、原文证据和错因，30-35 分钟", "广播体操或散步"),
        restDaily("2026-07-26", "周日完整休息/缓冲日：不安排学习任务"),
        daily("2026-07-27", "刑法课程 + 法理连续背诵 + 英语真题", "补最近未完成刑法课程块 90 分钟，不跨章跳跃", "核对一个最近闭环缺口并补齐，30 分钟", "法理第 2 章回背 25 分钟", dailyVocabularyTaskTitle, dailyEnglishReadingTaskTitle, "半天低负荷恢复"),
        ...
        daily("2026-07-29", "刑法课程 + 法理背诵 + 英语真题完形", "完成最近刑法课程缺口 90 分钟，记录剩余小节", "把一个最近缺口闭环到题目、主错因或正式框架图，30 分钟", "法理第 2 章回背 25 分钟", dailyVocabularyTaskTitle, dailyEnglishClozeTaskTitle, "按时结束"),
    ...
    private fun generatedFallbackPlan(date: LocalDate): DailyStudyPlan? {
        ...
        val recitation = when {
            date < LocalDate.of(2026, 9, 15) ->
                "背诵：已学科目第一轮结构和关键词 60-75 分钟；本周闭环章必须留下闭卷输出痕迹"
            date < LocalDate.of(2026, 10, 1) ->
                "背诵：补齐五科第一轮 90 分钟；按闭卷结果回炉，不用翻书熟悉感代替会背"
    ...
    fun plannedStudyMinutes(date: LocalDate = LocalDate.now()): Int {
        ...
        return when {
            ...
            date <= LocalDate.of(2026, 9, 14) -> 420
            date <= LocalDate.of(2026, 9, 30) -> 450
            date <= LocalDate.of(2026, 11, 30) -> 510
            date <= LocalDate.of(2026, 12, 14) -> 480
            else -> 300
        }
    }
    ...
    fun todaySchedule(date: LocalDate = LocalDate.now()): List<StudyScheduleBlock> {
        ...
        val dinnerStart = englishStart.plusMinutes(englishMinutes.toLong() + 10)
        val dinnerEnd = dinnerStart.plusMinutes(45)
        val politicsStart = dinnerEnd.plusMinutes(10)
        val recitationStart = if (includePolitics) {
            politicsStart.plusMinutes(politicsMinutes.toLong() + 10)
        } else {
            dinnerEnd.plusMinutes(10)
        }
        val academicEnd = when {
            includeRecitation -> recitationStart.plusMinutes(recitationMinutes.toLong())
            includePolitics -> politicsStart.plusMinutes(politicsMinutes.toLong())
            else -> dinnerEnd
        }
        ...
        return buildList {
            add(StudyScheduleBlock("09:30-09:40", "今日负荷", "今天按约 $studyBudget 分钟有效学习安排；新增题源、错题多轮、真题和模拟已经计入更高阶段预算。具体开始时间由你自己控制。"))
    ...
    fun dynamicSchedulePrompt(
        ...
        return buildString {
            ...
            appendLine("- 最近七天平均约 2 小时、昨天已完成 3 小时；本周健康日约 210 分钟，之后逐周爬到 270、330、360、390、420 分钟；9 月 15 日起约 450 分钟，10-11 月新增多层刷题/真题/政治后约 510 分钟，12 月前两周约 480 分钟。新增内容允许增加总时长，真正不适时才降到恢复档 $recoveryStudyMinutes 分钟；每周日休息。")
