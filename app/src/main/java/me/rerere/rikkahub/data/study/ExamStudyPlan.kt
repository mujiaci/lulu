...
object ExamStudyPlan {
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-12", "法理1补背 + 刑法3-4冲刺", "法理学第 1 章：正式闭卷背诵 45-60 分钟，复述目录树和关键词；完成前不跳到第 2 章", "刑法课程队列第 3-4 章：从第 3 章当前进度连续听约 3 小时，可拆 2-3 块；第 2 章课程已完成，第 6 章结束前不做第 2-6 章合并题", "课程结束后只整理关键词、不懂点和小框架 30-45 分钟", dailyVocabularyTaskTitle, "饭后完成第八套广播体操 3-4 节，晚上按时结束"),
        daily("2026-07-13", "法理2 + 刑法4-5冲刺", "法理学第 2 章：正式闭卷背诵 45-60 分钟", "刑法第 3 章如有尾课先补完，再连续推进第 4-5 章，课程输入合计约 3 小时；上一章完成即进入下一章", "刑法第 2-5 章只整理关键词和连接关系，第 2-6 章合并题继续冻结", dailyVocabularyTaskTitle, "饭后散步或手势舞 10-15 分钟"),
        daily("2026-07-14", "法理3 + 刑法5-6冲刺", "法理学第 3 章：正式闭卷背诵 45-60 分钟，完成法理 1-3 章连续入口", "刑法课程队列第 5-6 章：约 3 小时，优先确保第 6 章课程完整结束", "刑法第 2-6 章合并题：今天仍不提前开始；列出明日做题所需的易混点", dailyVocabularyTaskTitle, "第八套广播体操半套，晚间只做轻复盘"),
        daily("2026-07-15", "刑法2-6合并题集中闭环", "法理第 1-3 章：闭卷验收 45-60 分钟，卡点进入隔日回炉表", "确认刑法第 3-6 章课程全部完成；如有最后尾课，上午先限时补完", "刑法第 2-6 章合并题集中完成，随后整理主错因和连接框架；可拆上午、下午两个大块，不拆成零碎小任务", dailyLongSentenceTaskTitle, "身体缓冲：广播体操或轻走 15 分钟，不熬夜"),
