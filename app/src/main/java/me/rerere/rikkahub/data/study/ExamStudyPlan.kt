...
object ExamStudyPlan {
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-10", "刑法2第1主块 + 法理5封口", "刑法学第 2 章：听众合法硕刑法课程 75-90 分钟，作为第 1 个主块，老师讲到框架时跟着记，不单独预习目录", "刑法学第 2 章：课后只留 3-5 个关键词、1 个不懂点和一张小框架，不做整章题", "法理学第 5 章：用考试分析和错题本做正式背诵 30-40 分钟，留下 3 个最不稳关键词", "刑法第 1 章：把章节题错因补进框架图，做第一轮关键词背诵 15 分钟", "英语：不背单词 120 个，状态好再摘 1 个真题阅读小段做定位", "第八套广播体操选 2-3 节，动作小一点，只做身体润滑"),
        daily("2026-07-11", "刑法2第2主块 + 法理6", "刑法学第 2 章：听众合法硕刑法课程 75-90 分钟，作为第 2 个主块，继续抓构成要件和易混点", "刑法学第 2 章：课后补小框架和 3-5 个关键词，不刷整章题", "法理学第 6 章：正式背诵 30-40 分钟，闭卷口头复述目录树和关键词", "刑法第 1 章：只回看章节题错因和思维导图 15 分钟，不开民法", dailyLongSentenceTaskTitle, "饭后洗漱 + 手势舞一首歌，热天不强迫出门"),
        daily("2026-07-12", "刑法2第3主块 + 法理7", "刑法学第 2 章：听众合法硕刑法课程 60-90 分钟，作为第 3 个主块；如果整章未听完，只补剩余切片，不刷整章题", "刑法第 2 章：整理本章关键词、不懂点和小框架，准备后续章节题闭环", "法理学第 7 章：正式背诵 30-40 分钟，合上书复述目录树和关键词", "回看法理第 1-6 章错题，只标最常错的 5 个点", "整理一页本周不会背清单", "如果朋友有空，轻打羽毛球 20-30 分钟；没有就做第八套广播体操半套"),
        daily("2026-07-13", "刑法1整张章节题收口 + 刑法2框架", "刑法第 1 章：整章章节题补完剩余约 20-25 道，合计完成文运/众合章节题 1 张约 40 道；错题按概念不清、法条不熟、题干没读懂、选项陷阱归类", "刑法第 2 章：补本章小框架；如果整章已听完，再安排后续章节题，不提前挑题", "背诵：刑法第 1 章第一轮关键词 15 分钟；法理第 8 章正式背诵 30 分钟", "补本周漏掉的刑法框架图，框架必须服务背诵，不追求漂亮", "英语阅读预备：真题阅读 1 小段，只做题干定位和译文复述", "饭后低阻力整理桌面 10 分钟"),
        daily("2026-07-14", "轻量缓冲日", "今天不新增硬章节；只做缓冲、复盘和身体恢复", "法理第 1-8 章二次背诵 30 分钟，只背目录树和最不稳关键词", "刑法第 1 章：回看错题清单和思维导图，确认章节题 1 张约 40 道、错因、框架、第一轮关键词是否都有痕迹", "刑法第 2 章：统计已听分钟数、剩余小节和是否可以进入章节题", "英语：单词 120 个拆成 6 组，状态差可拆到早中晚", "第八套广播体操半套或手势舞一首歌，饭后不补课"),
        daily("2026-07-15", "刑法2闭环检查 + 刑法3入口", "刑法第 2 章：如果整章已听完，集中做章节题 15-20 道启动；如果没听完，先补剩余听课切片 60-90 分钟", "刑法第 2 章：课后写 3-5 个关键词、1 个不懂点和小框架，不开民法", "背诵：刑法第 1 章第一轮关键词，能复述结构即可", "画刑法第 1-2 章连接框架", dailyLongSentenceTaskTitle, "饭后配音乐原地踏步 8 分钟，脚踝和膝盖轻活动"),
        daily("2026-07-16", "刑法3第1主块 + 法理9", "刑法学第 3 章：听众合法硕刑法课程 60-90 分钟，作为第 1 个主块，课后只留关键词和不懂点", "刑法第 2 章：只回看小框架和错因 15 分钟，不零碎刷题", "法理学第 9 章：正式背诵 30-40 分钟，合上书复述目录树和关键词", "画刑法第 3 章入口框架", dailyVocabularyTaskTitle, "饭后洗漱 + 开窗站一会儿，等困劲过去再整理框架"),
        daily("2026-07-17", "刑法3第2主块 + 法理封口", "刑法学第 3 章：听众合法硕刑法课程 75-90 分钟，作为第 2 个主块，课后只留关键词和不懂点", "法理学第 9 章：只做 20-30 分钟目录树和关键词封口，不新开综合课第三支线", "背诵：法理第 1-8 章第二次滚动，只背目录和关键词", "刑法第 3 章：补一张小框架草图，服务后面做题和背诵", "英语阅读预备：从真题阅读里摘 1 句长难句拆解", "天气凉快就散步 15-20 分钟，天气热就手势舞一首歌"),
        daily("2026-07-18", "刑法3第3主块 + 本周回炉", "刑法学第 3 章：听众合法硕刑法课程 60-90 分钟，作为第 3 个主块，课后只留关键词和不懂点", "刑法第 2 章：回看已完成题目或小框架 15 分钟，不开民法", "背诵：刑法第 1 章第一轮关键词", "错题：只回看刑法第 1 章已闭环错题 5-10 题，未闭环不刷", dailyLongSentenceTaskTitle, "饭后低阻力整理错题清单；中间穿插转肩转腰 3 分钟"),
        daily("2026-07-19", "刑法3框架 + 刑法4入口", "刑法第 3 章：整理听课小框架和不懂点，如果整章已闭环再准备后续章节题", "刑法学第 4 章：只有第 3 章已经留下关键词和小框架，才听众合法硕刑法课程 45-60 分钟作为入口", "背诵：法理第 10 章正式背诵 30-40 分钟", "画刑法第 2-3 章小框架", "英语：单词 120 个；状态好做真题阅读 1 小段定位", "第八套广播体操选 3 节，不追求标准，只让身体顺一点"),
        daily("2026-07-20", "刑法4第1主块 + 法理11", "刑法第 4 章：听众合法硕刑法课程 75-90 分钟，作为第 1 个主块；如果状态差，就缩成 45 分钟并补关键词", "法理学第 11 章：正式背诵 30-40 分钟，不同时安排宪法/法制史", "刑法第 4 章：补构成要件和易混点小框架，准备后续整章闭环", "背诵：刑法第 2 章第一轮关键词 15 分钟", "英语：田静《句句真研》或真题阅读句子 1 句长难句", "饭后不做硬背诵，先听音乐慢走或寝室轻舞 10 分钟"),
        daily("2026-07-21", "周复盘：刑法主线 + 法理复线", "今天作为周复盘/缓冲，不新增大章节", "回看刑法第 1 章错题；刑法第 2-4 章只统计已听分钟数和未闭环切片", "民法、宪法、法制史不复盘进度，因为 7 月没有启动新学", "法理只用 30 分钟口头背目录，列出最卡的 3-5 章；不同时复盘宪法/法制史", "整理刑法已闭环范围里最常错 10 个点", "休息；朋友有空就轻打羽毛球 20-30 分钟，没有就开窗站 + 手势舞"),
        daily("2026-07-22", "法理12 + 刑法4第2主块", "法理学第 12 章：用考试分析和错题本回看、框架整理、第一轮关键词背诵", "刑法学第 4 章：听众合法硕刑法课程 60-90 分钟，作为第 2 个主块，听完写 3-5 个关键词和 1 个不懂点", "背诵：法理第 9-11 章第一轮目录和关键词", "画法理第 9-12 章思维导图", dailyLongSentenceTaskTitle, "饭后放音乐做肩颈和腰部轻活动 8-10 分钟"),
        daily("2026-07-23", "刑法4第3主块 + 法理12回炉", "刑法学第 4 章：听众合法硕刑法课程 60-90 分钟，作为第 3 个主块，课后只留关键词和不懂点", "刑法第 3 章：只复述已听关键词，未确认整章闭环前不算第一轮背诵", "法理第 12 章：正式背诵 30-40 分钟，合上书复述目录树", "画刑法第 3-4 章框架", "英语阅读预备：真题阅读 1 小段，标定位词和转折词", "饭后洗漱/整理桌面"),
        daily("2026-07-24", "刑法5第1主块 + 法理13", "刑法第 5 章：听众合法硕刑法课程 60-90 分钟，作为第 1 个主块，听完写 3-5 个关键词", "法理学第 13 章：用考试分析和错题本回看、框架整理、第一轮关键词背诵", "刑法第 4 章：只复述已听关键词，未确认整章闭环前不算第一轮背诵", "整理刑法第 1-5 章目录图", dailyLongSentenceTaskTitle, "天气舒服就散步 15-20 分钟；天气热就第八套广播体操选段"),
        daily("2026-07-25", "刑法5第2主块 + 刑法4闭环检查", "刑法第 5 章：听众合法硕刑法课程 60-90 分钟，作为第 2 个主块；状态一般就缩成 45 分钟并补关键词", "刑法第 4 章：如果整章已听完，整理框架和不懂点；本章结束前不单独安排题目", "背诵：法理第 1-13 章抽 3 章口头复述目录树", "整理刑法第 4 章入口框架一页，不追求完整章闭环", "英语：单词 120 个，状态好摘 1 句真题长难句", "饭后不刷题"),
        daily("2026-07-26", "刑法5第3主块 + 刑法4回炉", "刑法第 5 章：听众合法硕刑法课程 60-90 分钟，作为第 3 个主块；如果整章没听完，只补剩余切片", "刑法第 4 章：回看听课框架，标出混淆点和未闭环切片", "刑法第 3-4 章：只复述已听关键词，未闭环章节不算第一轮", "错题：只从确认整章闭环的刑法章节里挑 5-10 题；没闭环就不挑题", dailyLongSentenceTaskTitle, "手势舞一首歌 + 脚踝膝盖轻活动，少量多次补精力"),
        daily("2026-07-27", "刑法5框架 + 法理抽背", "刑法第 5 章：整理本章框架和关键词；如果整章已听完，判断是否可以进入章节题", "刑法第 4 章：只复述已听关键词，未闭环章节不算第一轮", "法理第 1-13 章：抽 2 章正式背诵 30 分钟", "画刑法第 4-5 章框架草图，资料整理不超过 20 分钟", "英语阅读预备：真题阅读 1 小段，口头复述译文", "饭后听音乐慢走；热天就在寝室原地踏步"),
        ...
        val mainTask = when (date.dayOfWeek) {
            DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY ->
                if (activeBook == "全科回炉") {
                    ...
                    "主线块：按本周$activeBook章节$activeCourse 60-90 分钟，写切片编号、3-5 个关键词和 1 个不懂点；未完成这本书前不启动下一本新课"
                }
            DayOfWeek.THURSDAY ->
                "主线块：只做已经整章闭环的章节题或错题回炉；未闭环章节只补听课切片和关键词"
            DayOfWeek.FRIDAY ->
                "主线块：按本周$activeBook范围做真题高频点锚定或主观题短答 1-2 题，做完回到具体章节"
            else ->
