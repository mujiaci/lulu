...
object ExamStudyPlan {
    ...
    val studyHabitReference = """
        ...
        - 用户可以倍速听课。倍速只压缩“听课输入时间”，不能压缩课后消化、做题、错题、框架和背诵痕迹；默认用能听懂的 1.25-1.5 倍速，复杂章节随时降速、暂停或回放。2026-07-11 校准后，全部新课必须在 9 月 14 日前完成；每本书按真实课时和闭环痕迹推进，周复盘只能调整日内切片，不能后移硬截止。
        ...
        - 2026-07-11 冲刺硬截止：12 月进入考试，10 月不得再以听课为主线。刑法新课 7 月 31 日前结束，民法 8 月 20 日前结束，宪法 8 月 31 日前结束，法制史 9 月 14 日前结束；9 月 15 日起全部专业课转背诵、题目、真题和主观题输出。正常日约 3 小时课程输入，另保留 45-60 分钟背诵和课后闭环。
    ...
    private val legacyMonthlyPlans = listOf(
        MonthlyStudyPlan(
            "2026-07",
            "稳启动：7月就开始背诵和章节闭环",
            listOf(
    ...
    private val legacyJulyWeeks = listOf(
        WeeklyStudyPlan(
            id = "2026-07-w1",
    ...
    private val legacyPostJulyWeeks = listOf(
        WeeklyStudyPlan(
            id = "2026-08-w1",
    ...
    val monthlyPlans = listOf(
        MonthlyStudyPlan("2026-07", "刑法冲刺收口，背诵从现在开始", listOf(
            "刑法：7 月 31 日前完成第 3-25 章课程及全书验收；第 3-6 章听完后统一完成第 2-6 章合并题、错因和连接框架",
            "背诵：法理第 1 章欠账优先补齐，随后第 1-13 章每天 45-60 分钟滚动闭卷；刑法闭环章节同步背关键词和规范表述",
            "日负荷：正常日课程输入约 3 小时，题目/框架/消化 60-90 分钟；倍速只压缩视频，不压缩输出",
        )),
        MonthlyStudyPlan("2026-08", "民法与宪法全部结束", listOf(
            "8 月 1-20 日：民法第 1-21 章，日均课程输入约 3-3.5 小时，每章完成题目、错因、框架和第一轮关键词；8 月 20 日整本验收",
            "8 月 21-31 日：宪法第 1-7 章课程与闭环；8 月 31 日整本验收",
            "法理、刑法每天滚动背诵，英语真题阅读每周 2-3 次；不允许新课吞掉背诵",
        )),
        MonthlyStudyPlan("2026-09", "9 月 14 日结束全部新课，转入正式复习", listOf(
            "9 月 1-14 日：法制史第 1-7 章课程、时间线、框架和第一轮关键词；9 月 14 日做全部专业课新课总验收",
            "9 月 15-30 日：五科第一轮背诵补齐，刑民题目和错题回炉，综合课框架与分科真题锚定",
            "每周至少 2 次主观题闭卷输出；9 月 15 日后不再把常规听课作为主线",
        )),
    ...
    val julyWeeks = listOf(
        ...
        WeeklyStudyPlan("2026-07-w2", "补法理欠账，完成刑法 2-6 章闭环", "2026-07-08 至 2026-07-15", listOf(
            "刑法第 1 章已闭环、第 2 章课程已完成；按顺序完成第 3-6 章课程后，统一做第 2-6 章合并题、错因和连接框架",
            "法理第 1-3 章顺延闭卷背诵，每天 45-60 分钟；第 1 章欠账优先",
            "正常日课程输入约 3 小时，不熬夜制造虚假进度",
        )),
        WeeklyStudyPlan("2026-07-w3", "刑法第 7-14 章高强度推进", "2026-07-16 至 2026-07-21", listOf(
            "从当前未完成章节连续推进，正常日安排 2-3 个课程主块；整章完成后再做题、错因、框架和关键词",
            "法理滚动背诵不断线，保留半天低负荷复盘",
        )),
        WeeklyStudyPlan("2026-07-w4", "刑法第 15-22 章高强度推进", "2026-07-22 至 2026-07-27", listOf(
            "课程输入约 3 小时，消化与题目 60-90 分钟；按实际课时滚动，不以跳章换取表面进度",
            "每天完成刑法已闭环章与法理的闭卷复述",
        )),
        WeeklyStudyPlan("2026-07-w5", "刑法第 23-25 章与整本验收", "2026-07-28 至 2026-07-31", listOf(
            "完成刑法第 23-25 章及遗留闭环；7 月 31 日按课程、题目、错因、框架、关键词五项做整本验收",
            "未通过项当天列成 8 月 1 日清晨限时补漏，不得侵占民法主线超过半天",
        )),
    )

    val postJulyWeeks = listOf(
        WeeklyStudyPlan("2026-08-w1", "民法第 1-7 章", "2026-08-01 至 2026-08-07", listOf("民法日均 3-3.5 小时课程输入，每章题目、错因、框架、关键词闭环", "法理与刑法每天滚动背诵 45-60 分钟，英语阅读 2 次")),
        WeeklyStudyPlan("2026-08-w2", "民法第 8-14 章", "2026-08-08 至 2026-08-14", listOf("继续民法唯一新课主线，章末必须有闭卷关键词输出", "周末做前 14 章连接框架和错题回炉")),
        WeeklyStudyPlan("2026-08-w3", "民法第 15-21 章与整本验收", "2026-08-15 至 2026-08-20", listOf("8 月 20 日完成民法整本验收：课程、题目、错因、框架、第一轮关键词", "刑法真题锚点与法理抽背不断线")),
        WeeklyStudyPlan("2026-08-w4", "宪法第 1-7 章与整本验收", "2026-08-21 至 2026-08-31", listOf("宪法课程、章节题、错因、框架和第一轮关键词全部完成", "8 月 31 日做宪法整本验收；英语阅读每周 3 次")),
        WeeklyStudyPlan("2026-09-w1", "法制史第 1-4 章", "2026-09-01 至 2026-09-07", listOf("建立朝代时间线、制度对比框架和第一轮关键词", "法理、刑法、民法、宪法滚动抽背")),
        WeeklyStudyPlan("2026-09-w2", "法制史第 5-7 章与全部新课验收", "2026-09-08 至 2026-09-14", listOf("9 月 14 日完成法制史整本及五科全部新课总验收", "未达标内容只做限时高频补漏，不把常规听课拖入 9 月 15 日以后")),
        WeeklyStudyPlan("2026-09-w3", "五科第一轮背诵补齐", "2026-09-15 至 2026-09-21", listOf("按闭卷结果补齐五科第一轮，刑民错题回炉，综合课框架串联", "完成 2 次主观题闭卷输出")),
        WeeklyStudyPlan("2026-09-w4", "真题锚定与第一轮验收", "2026-09-22 至 2026-09-30", listOf("分科真题定位高频点，第一轮背诵总验收", "每周至少 2 次主观题闭卷输出并订正")),
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-16", "刑法2-6合并题闭环", "确认刑法第 3-6 章课程全部完成；若仍有尾课，先用约 3 小时课程主块补齐", "完成第 2-6 章合并题、主错因和连接框架；未完成可顺延至明日上午", "法理第 4 章闭卷背诵 45-60 分钟", dailyVocabularyTaskTitle, "广播体操或散步后按时休息"),
        daily("2026-07-17", "刑法7-9高强度推进", "刑法课程队列第 7-9 章：从当前未完成处连续推进，课程输入约 3 小时", "闭环章完成题目、错因、框架和关键词；未闭环章只记卡点", "法理第 5 章闭卷背诵 45-60 分钟", dailyVocabularyTaskTitle, "不熬夜追表面章数"),
        daily("2026-07-18", "刑法9-11高强度推进", "刑法课程队列第 9-11 章：约 3 小时，上一章结束立即进入下一章", "已闭环章集中消化 60-90 分钟", "法理第 6 章闭卷背诵 45-60 分钟", dailyLongSentenceTaskTitle, "广播体操 10 分钟"),
        daily("2026-07-19", "刑法11-13高强度推进", "刑法课程队列第 11-13 章：约 3 小时，不跳章", "题目、错因、框架和关键词跟随闭环章", "法理第 1-6 章抽背 45-60 分钟", dailyVocabularyTaskTitle, "饭后散步"),
        daily("2026-07-20", "刑法13-14推进", "刑法课程队列推进至第 14 章附近，课程输入约 3 小时", "整理本周已闭环章最常错 10 点", "法理第 7 章闭卷背诵 45-60 分钟", dailyLongSentenceTaskTitle, "晚上按时结束"),
        daily("2026-07-21", "低负荷复盘与补漏", "只补刑法第 7-14 章实际未完成的最近课程块，不跨章", "回炉本周错题和框架 60 分钟", "法理第 4-7 章抽背 45 分钟", dailyVocabularyTaskTitle, "半天低负荷恢复"),
        daily("2026-07-22", "刑法15-17高强度推进", "刑法课程队列第 15-17 章：约 3 小时", "闭环章完成题目、错因、框架、关键词", "法理第 8 章闭卷背诵 45-60 分钟", dailyVocabularyTaskTitle, "广播体操 10 分钟"),
        daily("2026-07-23", "刑法17-19高强度推进", "刑法课程队列第 17-19 章：约 3 小时", "消化和题目 60-90 分钟", "法理第 9 章闭卷背诵 45-60 分钟", dailyLongSentenceTaskTitle, "饭后轻活动"),
        daily("2026-07-24", "刑法19-20高强度推进", "刑法课程队列推进至第 20 章附近，约 3 小时", "闭环痕迹不齐的章节当日补齐", "法理第 10 章闭卷背诵 45-60 分钟", dailyVocabularyTaskTitle, "不熬夜"),
        daily("2026-07-25", "刑法20-21高强度推进", "刑法课程队列推进至第 21 章附近，约 3 小时", "错题按知识点和主错因压缩", "法理第 11 章闭卷背诵 45-60 分钟", dailyLongSentenceTaskTitle, "广播体操或散步"),
        daily("2026-07-26", "刑法21-22推进", "刑法课程队列推进至第 22 章，约 3 小时", "题目、错因、框架和关键词集中闭环", "法理第 8-11 章抽背 45 分钟", dailyVocabularyTaskTitle, "晚间只复盘"),
        daily("2026-07-27", "刑法15-22阶段验收", "补最近未完成课程块，完成第 15-22 章阶段验收", "列出最后四天必须完成的课程分钟和闭环缺口", "法理第 12 章闭卷背诵 45-60 分钟", dailyVocabularyTaskTitle, "半天低负荷恢复"),
        daily("2026-07-28", "刑法23推进", "刑法第 23 章课程队列约 3 小时，完成即进入下一章", "已闭环内容做题和框架 60-90 分钟", "法理第 1-12 章抽背 45 分钟", dailyLongSentenceTaskTitle, "广播体操 10 分钟"),
        daily("2026-07-29", "刑法24推进 + 法理13", "刑法第 24 章课程队列约 3 小时", "补第 23-24 章题目、错因、框架和关键词", "法理第 13 章闭卷背诵 45-60 分钟", dailyVocabularyTaskTitle, "按时结束"),
        daily("2026-07-30", "刑法25与遗留补漏", "完成刑法第 25 章课程及全书最后课程缺口", "完成第 23-25 章题目、错因、框架和关键词", "法理 13 章总目录闭卷复述 45-60 分钟", dailyLongSentenceTaskTitle, "准备明日验收清单"),
        daily("2026-07-31", "刑法整本验收", "刑法第 1-25 章整本验收：课程账本、章节题、错因、框架、关键词五项逐章核对", "抽取薄弱章节闭卷复述并做代表题；缺口列入 8 月 1 日清晨半天内限时补完", "法理最不稳 20 点抽背 45-60 分钟", "准备 8 月 1 日民法第 1 章入口", "不以熬夜破坏 8 月民法主线"),
    ).associateBy { it.date }
