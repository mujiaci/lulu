...
object ExamStudyPlan {
    ...
    val julyWeeks = listOf(
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法第 1 章已完成听课：本周完成文运/众合章节题 1 张约 $chapterPracticeQuestionsPerSet 道，7 月 8 日先做 15-20 道启动；因 7 月 8 日忙碌，刑法框架图和法理第 1-3 章背诵仍按未完成处理，7 月 9-10 日优先补上；7 月 13 日补完剩余 20-25 道并整理错因，再回到考试分析标选择题陷阱、案例分析入口和犯罪论答题骨架",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                "法理学第 5-8 章：按章节顺序完成目录树和关键词背诵，并用 15 分钟回炉第 1-4 章最容易忘的目录",
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-10", "补昨日欠账第1段 + 刑法2入口", "昨日法理第 1-3 章欠账第 1 段：只背法理第 1 章 20-25 分钟，闭卷复述目录树和最卡关键词，不跨到后续章节", "昨日刑法第 1 章框架图欠账：先画犯罪论入口与构成要件主干 20-25 分钟，今天只完成上半张", "刑法学第 2 章：听众合法硕刑法课程 60-75 分钟，作为第 1 个主块，课后只留 3-5 个关键词和 1 个不懂点", "法理连续性检查：今天不安排第 4 章及以后内容，第 1-3 章验收后再继续", "英语：不背单词 120 个可拆到早中晚，状态差就只保底", "第八套广播体操选 2-3 节，晚上不因欠账继续熬夜"),
        daily("2026-07-11", "补昨日欠账第2段 + 刑法2推进", "昨日法理第 1-3 章欠账第 2 段：只背法理第 2 章 20-25 分钟，先复述目录再攻卡住的关键词", "昨日刑法第 1 章框架图欠账：补选择题陷阱、案例分析入口和错因，20-30 分钟内合成完整一张", "刑法学第 2 章：听众合法硕刑法课程 60-75 分钟，作为第 2 个主块，不刷整章题", "法理第 1 章快速回看 10 分钟，只检查昨天卡点，不开第 3 章以后的内容", dailyLongSentenceTaskTitle, "饭后洗漱 + 手势舞一首歌，热天不强迫出门"),
        daily("2026-07-12", "法理1-3连续验收 + 本周收口", "法理第 3 章：正式背诵 20-25 分钟，闭卷复述目录树和关键词，完成欠账最后一段", "法理第 1-3 章连续验收：每章口头复述 5 分钟，仍不会的点写入下周回收清单，不继续硬磨", "刑法第 1 章框架图验收：看图复述犯罪论主干 10-15 分钟，只修影响理解的缺口", "刑法学第 2 章：听众合法硕刑法课程 60 分钟；如果疲劳，只整理已有关键词和不懂点", "整理一页下周回收清单：法理 1-3 残留点、刑法 1 框架缺口；不虚构法理后续章欠账", "如果朋友有空，轻打羽毛球 20-30 分钟；没有就做第八套广播体操半套"),
        daily("2026-07-13", "刑法1收口 + 法理4顺序续接", "刑法第 1 章：整章章节题补完剩余约 20-25 道；错题按概念不清、法条不熟、题干没读懂、选项陷阱归类", "从 7 月 12 日回收清单只挑 2 个法理第 1-3 章残留点复述 15 分钟", "刑法第 2 章：补本章小框架；如果整章已听完，再安排后续章节题", "法理第 4 章入口 20-25 分钟：只有第 1-3 章完成连续验收后才开始，闭卷复述目录树和关键词", "英语阅读预备：真题阅读 1 小段，只做题干定位和译文复述", "饭后低阻力整理桌面 10 分钟"),
        ...
        daily("2026-07-15", "刑法2闭环检查 + 法理5", "刑法第 2 章：如果整章已听完，集中做章节题 15-20 道启动；如果没听完，先补剩余听课切片 60-90 分钟", "刑法第 2 章：课后写 3-5 个关键词、1 个不懂点和小框架，不开民法", "法理学第 5 章：正式背诵 30-40 分钟，合上书复述目录树和关键词", "背诵：刑法第 1 章第一轮关键词，能复述结构即可", "画刑法第 1-2 章连接框架", "饭后配音乐原地踏步 8 分钟，脚踝和膝盖轻活动"),
        daily("2026-07-16", "刑法3第1主块 + 法理6", "刑法学第 3 章：听众合法硕刑法课程 60-90 分钟，作为第 1 个主块，课后只留关键词和不懂点", "刑法第 2 章：只回看小框架和错因 15 分钟，不零碎刷题", "法理学第 6 章：正式背诵 30-40 分钟，合上书复述目录树和关键词", "画刑法第 3 章入口框架", dailyVocabularyTaskTitle, "饭后洗漱 + 开窗站一会儿，等困劲过去再整理框架"),
        daily("2026-07-17", "刑法3第2主块 + 法理7", "刑法学第 3 章：听众合法硕刑法课程 75-90 分钟，作为第 2 个主块，课后只留关键词和不懂点", "法理学第 7 章：正式背诵 30-40 分钟，闭卷复述目录树和关键词", "背诵：法理第 1-6 章只抽最不稳的 2 章回看目录，不跨章追进度", "刑法第 3 章：补一张小框架草图，服务后面做题和背诵", "英语阅读预备：从真题阅读里摘 1 句长难句拆解", "天气凉快就散步 15-20 分钟，天气热就手势舞一首歌"),
        ...
        daily("2026-07-19", "刑法3框架 + 法理8", "刑法第 3 章：整理听课小框架和不懂点，如果整章已闭环再准备后续章节题", "刑法学第 4 章：只有第 3 章已经留下关键词和小框架，才听众合法硕刑法课程 45-60 分钟作为入口", "背诵：法理第 8 章正式背诵 30-40 分钟", "画刑法第 2-3 章小框架", "英语：单词 120 个；状态好做真题阅读 1 小段定位", "第八套广播体操选 3 节，不追求标准，只让身体顺一点"),
