...
object ExamStudyPlan {
    ...
    val monthlyPlans = listOf(
        MonthlyStudyPlan(
            ...
            listOf(
                ...
                "题目/真题：闭环章节当天或次日做章节题并标主错因；真题只做高频点锚定，不大量刷",
    ...
    val julyWeeks = listOf(
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法第 1 章：截至 2026-07-06 已看完课程；7 月 7 日起不再补听课，改做文运/众合章节题、错题主错因、框架图/思维导图和第一轮关键词背诵",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法第 1 章已完成听课：本周集中做文运/众合章节题 10-15 题，错题只标 1 个主错因，并画一张方便背诵的犯罪论入口框架/思维导图",
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-07", "刑法1闭环启动 + 民法1准备", "刑法第 1 章：已看完课程，今天不再补听课；做文运/众合章节题 10-15 题，只标 1 个主错因", "刑法第 1 章：画一张方便背诵的犯罪论入口框架/思维导图，只保留主干、构成要件和易混点", "法理第 1-3 章：回看错题和目录背诵卡点，封口 15 分钟", "民法第 1 章：只做 10 分钟课前目录预览，标出主体、民事法律关系、权利义务这几个入口词，不急着做题", "英语阅读预备：从真题阅读里摘 1 句长难句，只做主干、修饰和译文复述", "好好吃一顿饭；天气不热就散步 20 分钟，热就改寝室音乐轻舞 1 首歌"),
        daily("2026-07-08", "法理5 + 民法1第1主块", "法理学第 5 章：用考试分析和错题本回看目录、框架、关键词，完成第一轮背诵痕迹", "民法第 1 章：听众合法硕民法课程 75-90 分钟，作为民法连续单元第 1 个主块，抓主体、民事法律关系和权利义务入口", "刑法第 1 章：回看昨天章节题错因 15 分钟，不再补听课", "画法理第 1-5 章小总图，资料整理不超过 20 分钟", dailyVocabularyTaskTitle, "饭后只做手势舞一首歌或整理桌面，不开新课"),
        daily("2026-07-09", "民法1第2主块", "民法第 1 章：听众合法硕民法课程 75-90 分钟，作为民法连续单元第 2 个主块，抓主体和民事法律关系入口", "民法第 1 章：课后只留 3-5 个关键词、1 个不懂点和一个主体/法律关系小框架，不急着做整章题", "法理学第 6 章：用考试分析做目录树第一轮背诵，并补 3 个不稳关键词", "刑法第 1 章：只复述章节题错因和框架 10 分钟，保温但不新开大块", dailyLongSentenceTaskTitle, "饭后开窗站一会儿，配音乐转肩、转腰、脚踝绕圈 8-10 分钟"),
        daily("2026-07-10", "法理7 + 民法1第3主块", "法理学第 7 章：错题回看并背关键词，验收为能口头说出本章目录", "民法第 1 章：听众合法硕民法课程 75-90 分钟，作为民法连续单元第 3 个主块，继续抓主体、意思表示和民事法律关系", "刑法第 1 章：把章节题错因补进框架图，做第一轮关键词背诵 15 分钟", "背诵：法理第 5-6 章第一轮目录和关键词", "英语：不背单词 120 个，状态好再摘 1 个真题阅读小段做定位", "第八套广播体操选 2-3 节，动作小一点，只做身体润滑"),
        daily("2026-07-11", "民法1框架收口", "民法第 1 章：如果整章已听完，开始画主体/法律关系框架图；如果没听完，只补剩余小节，不刷章节题", "民法第 1 章：框架图服务背诵，只保留主体、权利义务、法律事实、法律关系这几条主干", "刑法第 1 章：只回看章节题错因和思维导图 15 分钟，不开刑法第 2 章", "背诵：民法第 1 章关键词 15 分钟，只背入口概念", dailyLongSentenceTaskTitle, "饭后洗漱 + 手势舞一首歌，热天不强迫出门"),
        ...
        daily("2026-07-13", "刑法1回炉 + 民法1框架", "刑法第 1 章：回看文运/众合章节题错因 10-15 题，按概念不清、法条不熟、题干没读懂、选项陷阱归类", "民法第 1 章：补主体和法律关系框架；若整章听完，再做少量章节题并标主错因，未听完则只补课和小框架", "背诵：刑法第 1 章第一轮关键词 15 分钟，民法第 1 章只背入口关键词", "补本周漏掉的框架图，框架必须服务背诵，不追求漂亮", "英语阅读预备：真题阅读 1 小段，只做题干定位和译文复述", "饭后低阻力整理桌面 10 分钟"),
        daily("2026-07-14", "轻量缓冲日", "今天不新增硬章节；只做缓冲、复盘和身体恢复", "法理第 1-7 章二次背诵 20 分钟，只背目录树", "刑法第 1 章：回看错题清单和思维导图，确认章节题、错因、框架、第一轮关键词是否都有痕迹", "民法第 1 章：统计已听分钟数、剩余小节和是否可以进入章节题", "英语：单词 120 个拆成 6 组，状态差可拆到早中晚", "第八套广播体操半套或手势舞一首歌，饭后不补课"),
