...
object ExamStudyPlan {
    ...
    val monthlyPlans = listOf(
        MonthlyStudyPlan(
            ...
            listOf(
                ...
                "不背单词约 $vocabularyBacklog 个复习池按 20 个一组滚动；非完整休息日每天固定 $dailyVocabularyTaskTitle；$dailyLongSentenceTaskTitle",
                "7 月英语只做阅读预备：长难句用田静《句句真研》/颉斌斌 66 句/真题阅读句子三选一，每次只拆 1 句或 1 小段；不做完整限时阅读",
                "专业课每天按可验收动作推进：听众合法硕课程切片、3-5 个关键词、1 个不懂点、小框架；资料整理最多 10-20 分钟",
                "每周至少 1 天完整休息/缓冲；用户明确选择休息日时当天任务清零，原任务顺延到后面 2-3 天轻量分摊",
            ),
        ),
        MonthlyStudyPlan(
            "2026-08",
    ...
    val julyWeeks = listOf(
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法第 1 章：本周因 7 月 4 日休息，目标调整为累计听课约 2.5-3.5 小时，完成 3 个左右切片；每个切片后写关键词、1 个不懂点或小框架",
                "刑法第 1 章没听完整前不单独安排题目；课上例题算在听课里，课后只留关键词和不懂点",
                "法理第 1-3 章：错题回看、第一轮背诵和框架补洞，不重复从零听课",
                "民法第 1 章只做入口：30-60 分钟听课 + 关键词框架，作为第二主线预热，不急着刷整章题",
                "英语先恢复连续性：非完整休息日固定 $dailyVocabularyTaskTitle；7 月只做阅读预备，长难句至少 2-3 句，不做完整限时阅读",
                "第 7 天复盘本周已听分钟数、错题和下周第一步；休息日是系统恢复，不用学习任务证明连续性",
            ),
        ),
        WeeklyStudyPlan(
            id = "2026-07-w2",
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-05", "休息后重启：刑法1主块 + 法理小封口", "上午先慢启动，热水、清淡早饭、整理桌面 10 分钟后再开始", "刑法学第 1 章：听众合法硕刑法课程 75-90 分钟，作为休息后第 2 个切片，抓犯罪论总入口和构成要件", "刑法学第 1 章：听完只写 3-5 个关键词和 1 个不懂点，不单独安排题目；课上例题算在听课里", "法理学第 2 章：第一轮背诵 20 分钟，背目录树和关键词，卡住再看框架提示", dailyVocabularyTaskTitle, "饭后散步 15-20 分钟；晚上只做框架封口和提前睡"),
        daily("2026-07-06", "刑法1继续 + 民法1入口", "刑法学第 1 章：听众合法硕刑法课程 75-90 分钟，作为第 3 个切片，听完补构成要件小框架", "刑法学第 1 章：只补 3 个关键词和 1 个不懂点，不单独安排题目；课上例题算在听课里", "民法第 1 章：听众合法硕民法课程 30-45 分钟，抓主体和民事法律关系入口", "民法第 1 章：只写 3-5 个入口关键词和 1 个不懂点，不急着做整章题", dailyVocabularyTaskTitle, "散步 15-20 分钟"),
        daily("2026-07-07", "第一周复盘 + 刑法轻补", dailyVocabularyTaskTitle, "刑法学第 1 章：听众合法硕刑法课程 45-60 分钟，只补一个轻切片或回看已听切片，不单独安排题目", "统计刑法第 1 章本周已听分钟数、已学范围和未闭环切片", "回看法理第 1-3 章错题和目录背诵卡点", "回看民法第 1 章入口关键词，补 5 个关键词", "好好吃一顿饭，散步 20 分钟"),
        ...
        daily("2026-07-21", "周复盘：五科第一次同屏", "回看刑法第 1 章错题；刑法第 2 章只统计已听分钟数和未闭环切片", "回看民法第 1 章错题；民法第 2 章只统计已听分钟数和未闭环切片", "法理第 1-11 章口头背目录", "整理已闭环范围里最常错 10 个点", "休息或散步 30 分钟"),
        ...
        daily("2026-07-23", "刑法3第2切片 + 民法3入口", "刑法学第 3 章：听众合法硕刑法课程 60-90 分钟，作为第 2 个切片，课后只留关键词和不懂点", "民法第 3 章：听众合法硕民法课程 30-45 分钟，只抓入口", "刑法第 2 章：只复述已听关键词，未确认整章闭环前不算第一轮背诵", "画刑法第 2-3 章框架"),
        daily("2026-07-24", "民法3第1切片 + 法理13", "民法第 3 章：听众合法硕民法课程 60-90 分钟，作为第 1 个切片，听完写 3 个关键词", "法理学第 13 章：错题回看、框架整理、第一轮背诵", "民法第 2 章：只复述已听关键词，未确认整章闭环前不算第一轮背诵", "整理民法第 1-3 章目录图"),
        ...
        daily("2026-07-26", "刑法3回炉 + 刑法4入口", "刑法学第 4 章：听众合法硕刑法课程 60-90 分钟，作为第 1 个切片，听完写 3 个关键词", "刑法第 3 章：回看听课框架，标出混淆点", "刑法第 2-3 章：只复述已听关键词，未闭环章节不算第一轮", "错题：只从确认整章闭环的刑法章节里挑 10 题；没闭环就不挑题"),
        daily("2026-07-27", "民法3回炉 + 民法4入口", "民法第 4 章：听众合法硕民法课程 60-90 分钟，作为第 1 个切片，听完写 3 个关键词", "民法第 3 章：回看听课框架，标出混淆点", "民法第 2-3 章：只复述已听关键词，未闭环章节不算第一轮", "画民法第 3-4 章框架"),
        daily("2026-07-28", "阶段复盘日", "法理第 1-13 章目录背诵", "刑法第 1-4 章：统计已听分钟数、未闭环切片和已闭环范围错题", "民法第 1-4 章：统计已听分钟数、未闭环切片和已闭环范围错题", "整理 7 月错题清单和背诵清单"),
        ...
        daily("2026-07-30", "民法4第2切片 + 宪法2入口", "民法第 4 章：听众合法硕民法课程 60-90 分钟，作为第 2 个切片，课后只留关键词和不懂点", "宪法学第 2 章：听众合法硕宪法课程 30-45 分钟，只抓入口", "刑法第 3-4 章：只复述已听关键词，未闭环章节不算第一轮", "画宪法第 1-2 章框架"),
