...
object ExamStudyPlan {
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-03", "恢复日：补法理2入口", "身体恢复优先：早上不补硬任务，先吃清淡、喝热水、整理桌面 10 分钟", "法理学第 2 章：只回看错题和框架 30-40 分钟，不背完整表述", dailyVocabularyTaskTitle, "如果肚子仍不舒服，只保留英语和法理 20 分钟；晚上提前收尾"),
        daily("2026-07-04", "刑法1入口 + 法理2封口", "刑法学第 1 章：听众合法硕刑法课程 30-45 分钟，只抓犯罪论总入口", "刑法学第 1 章：做 5-8 题并标错因，不追求题量", "法理学第 2 章：用 10 分钟口头复述框架", dailyVocabularyTaskTitle, "晚上不加新课，只做轻收尾"),
