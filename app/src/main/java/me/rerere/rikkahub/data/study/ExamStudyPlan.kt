...
object ExamStudyPlan {
    ...
    val studyHabitReference = """
        ...
        - 排刑法、民法新章时，默认拆成 60-90 分钟听课切片 + 章节题 + 错题/框架 + 第一轮背诵；恢复日可缩成 30-60 分钟入口切片，但不要把一章压成一个短任务。
    ...
    val monthlyPlans = listOf(
        MonthlyStudyPlan(
            "2026-07",
            "专业课稳启动：法理找回，刑民按课时切片开局，英语按复习池分组不断线",
            listOf(
                ...
                "刑法学、民法从零启动但按课时切片推进：每个新章先拆 60-90 分钟听课块，听完立刻做小题、关键词和框架，不把短听课当成完成一章",
                "宪法学、法制史只轻量入门，不和刑民抢主力时间",
                "7 月刑民目标按实际课时滚动校准：优先把刑法第 1 章 6 小时课程扎实拆完，再推进刑法 2-4/5、民法 1-4/5；不把冲到第 13 章当硬指标",
        ...
        MonthlyStudyPlan(
            ...
            listOf(
                "续接 7 月实际进度推进刑法、民法一轮：优先保证听课切片、章节题和框架闭环，不用为追章节数牺牲消化",
                "宪法学、法制史继续按轻量切片推进，先完成入门框架，再逐步补题和背诵",
        ...
        MonthlyStudyPlan(
            ...
            "专业课二轮主体与政治轻启动",
            listOf(
                "五科二轮背诵进入主线：每天至少一次闭卷复述，优先处理说不出来的章节",
                "刑民与综合课开始分题型训练，错题按原因归档，不用题量掩盖盲点",
                "政治轻启动：每天 20-30 分钟选择题或基础课，不抢专业课黄金时段",
                "英语阅读稳定训练，每周复盘错题来源；单词复习池继续按 20 个一组滚动，不追求一天清空",
            ),
        ),
        MonthlyStudyPlan(
            "2026-10",
            "三轮背诵与真题训练",
            listOf(
                "专业课从会看转向会写：主观题表达、法言法语和踩点意识优先",
                "历年真题分科训练，做完当天复盘，不把错题留成情绪债",
                "英语作文模板搭建并开始小作文/大作文轮换输出",
        ...
        MonthlyStudyPlan(
            ...
            "冲刺背诵与套卷节奏",
            listOf(
                "专业课高频点反复输出，背不熟的章节进入隔日回炉",
                "英语作文定稿，阅读错题只保留高频错因，不再做无边界扩张",
                "政治高频题和错题本收束，选择题保持手感",
                "每周模拟并复盘错因；复盘比多刷一套更重要",
            ),
        ),
        MonthlyStudyPlan(
            "2026-12",
            "保温、模拟与作息校准",
            listOf(
                "不再开新坑，只保温错题、高频点、作文模板和政治易混点",
                "模拟以校准节奏为主，不用成绩波动审判自己",
                "每天保留轻量英语和政治手感，专业课背诵短频快回炉",
                "睡眠节律稳定优先，考前一周把焦虑降到可行动水平",
            ),
        ),
    )
    ...
    val julyWeeks = listOf(
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法学第 1 章：按 6 小时课程拆成多个切片，只要每次听完留下关键词、错题或小框架，就算有效推进",
                "民法第 1 章：轻启动入口，先抓民事主体、法律关系和题感，不和刑法第 1 章抢长时段",
                "英语先恢复连续性：每天固定 $dailyVocabularyTaskTitle；长难句每周至少 3 句，每次写清来源和拆句步骤，不追复习池总数",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法学第 1 章收口 + 第 2 章入口：优先把 6 小时课程听课痕迹、章节题和犯罪论总入口闭环",
                "民法第 1 章收口 + 第 2 章入口：民事法律行为、主体和代理先建立题感",
                "不背单词固定 $dailyVocabularyTaskTitle；长难句每周至少 3 句，从颉斌斌 66 句/田静《句句真研》/真题中固定一个来源，不和单词互相惩罚",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法学第 2-3 章：继续按 60-90 分钟切片推进，做题后整理错因",
                "民法第 2-3 章：民事法律行为、代理和物权入口先抓结构，不追求一口气听完整章",
                "宪法学第 1 章、法制史第 1 章入门",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法学第 3-4 章、民法第 3-4 章：按课时切片推进，能闭环的章节当天补题和框架",
                "宪法学第 1-2 章、法制史第 1-2 章：轻量入门，不挤占刑民主力时间",
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法学、民法按实际听课分钟数收口：优先补完第 4 章附近的未闭环切片，状态好再开第 5 章入口",
                "宪法学第 2 章、法制史第 2 章补入口和框架",
                "不背单词只按当天 $dailyVocabularyTaskTitle 走，不在月底突击清空总池",
                "整理 7 月背诵清单、错题清单、框架图清单和各科已听分钟数，给 8 月安排续接入口",
            ),
        ),
    )
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-03", "慢启动但能学：法理2 + 刑法1切片", "起床后先吃清淡、喝热水、洗漱，整理桌面 10 分钟；今天不追上午时长", "法理学第 2 章：回看错题和目录框架 30-40 分钟，不背完整表述、不补难题", "刑法学第 1 章：听众合法硕刑法课程 30-40 分钟，作为 6 小时课程的恢复日入口切片", "不背单词 120 个（6 组）：拆成 3 次完成，每次 2 组，中间必须离桌休息", "饭后散步或慢走 15-20 分钟，等困劲过去再回桌面", "睡前 10 分钟写明天第一步，23:30 前结束学习入口"),
        daily("2026-07-04", "恢复后轻推进：刑法1切片 + 法理2封口", "上午先观察身体状态，热水、清淡早饭、整理桌面 10 分钟后再开始", "刑法学第 1 章：听众合法硕刑法课程 40-50 分钟，作为第 2 个切片，抓犯罪论总入口和构成要件", "刑法学第 1 章：做 5-8 题并标错因，不追求题量", "法理学第 2 章：用 15 分钟口头复述框架，卡住就看目录提示", dailyVocabularyTaskTitle, "晚上只做轻收尾和提前睡；如果白天状态好，再加长难句 1 句"),
        daily("2026-07-05", "法理3 + 民法1轻启动", "法理学第 3 章：目录式回忆并补框架", "民法第 1 章：听众合法硕民法课程 30-45 分钟，抓主体和民事法律关系入口", "民法第 1 章：只做 5-8 题建立题感", "散步 15 分钟"),
        daily("2026-07-06", "刑法1第3切片 + 法理回背", "刑法学第 1 章：听众合法硕刑法课程 60-75 分钟，作为第 3 个切片，听完补 5 题并标错因", "法理第 1-3 章：目录式回背 20 分钟", "背诵：法理第 2-3 章关键词，不追求一口气背完", dailyVocabularyTaskTitle, "散步或拉伸 20 分钟"),
        daily("2026-07-07", "第一周复盘与容错", dailyVocabularyTaskTitle, "回看法理第 1-3 章错题", "回看刑法第 1 章已听切片和民法第 1 章入口题，补 5 个关键词", "补一个本周漏掉的小任务，只补最小一块", "好好吃一顿饭，散步 20 分钟"),
        ...
        daily("2026-07-09", "法理6 + 民法1第2切片", "法理学第 6 章：目录式回忆并补框架", "民法第 1 章：听众合法硕民法课程 60-75 分钟，作为第 2 个切片，听完做 5-8 题", "背诵：刑法第 1 章已听关键词 10 分钟", "画民法第 1 章入口框架", dailyLongSentenceTaskTitle),
        ...
        daily("2026-07-11", "民法1收口 + 刑法1题感", "民法第 1 章：听众合法硕民法课程 60-75 分钟，作为第 3 个切片，听完做 5-8 题", "刑法学第 1 章：回看已听切片，做 8-10 题并标错因", "背诵：民法第 1 章关键词", "画民法法律关系框架", dailyVocabularyTaskTitle),
        daily("2026-07-12", "法理8 + 本周闭环", "法理学第 8 章：错题回看、框架整理、第一轮背诵", "回看法理第 1-7 章错题", "口头背诵法理第 1-8 章标题和关键词", "画法理第 1-8 章总框架", "整理一页本周不会背清单"),
        daily("2026-07-13", "刑法1收口 + 民法1错题", "刑法第 1 章：补 10 题并把错因分成概念不清、法条不熟、题干没读懂", "民法第 1 章：错题回看 8 题，补主体和法律关系框架", "背诵：刑法/民法各 15 分钟，只背关键词", "补本周漏掉的框架图"),
        daily("2026-07-14", "轻量缓冲日", dailyVocabularyTaskTitle, "法理第 1-7 章二次回背 20 分钟", "刑法第 1 章错题回看，确认 6 小时课程还缺哪些切片", "散步 20 分钟"),
        ...
        daily("2026-07-16", "民法2第1切片 + 宪法1入口", "民法第 2 章：听众合法硕民法课程 60-90 分钟，作为第 1 个完整切片，听完做 5 题", "宪法学第 1 章：听众合法硕宪法课程 30-45 分钟，只抓总入口", "背诵：民法第 1 章第一轮关键词", "画宪法第 1 章入口框架", dailyVocabularyTaskTitle),
        daily("2026-07-17", "法理9 + 法制史1入口", "法理学第 9 章：错题回看、框架整理、第一轮背诵", "法制史第 1 章：听众合法硕法制史课程 30-45 分钟，抓朝代线索入口", "背诵：法理第 1-8 章第二次滚动", "整理法制史时间线入口图"),
        daily("2026-07-18", "刑法2第2切片 + 本周错题", "刑法学第 2 章：听众合法硕刑法课程 60-90 分钟，作为第 2 个切片，听完补 5-8 题", "民法第 2 章：回看第 1 切片关键词 15 分钟", "背诵：刑法第 1 章第一轮", "错题：刑法本周错题回看"),
        daily("2026-07-19", "民法2第2切片 + 刑法2框架", "民法第 2 章：听众合法硕民法课程 60-90 分钟，作为第 2 个切片，听完做 5-8 题", "刑法第 2 章：整理听课小框架和错因", "背诵：民法第 1 章第一轮", "画民法第 1-2 章小框架"),
        ...
        daily("2026-07-23", "刑法3第2切片 + 民法3入口", "刑法学第 3 章：听众合法硕刑法课程 60-90 分钟，作为第 2 个切片，听完补 5-8 题", "民法第 3 章：听众合法硕民法课程 30-45 分钟，只抓入口", "背诵：刑法第 2 章第一轮关键词", "画刑法第 2-3 章框架"),
        daily("2026-07-24", "民法3第1切片 + 法理13", "民法第 3 章：听众合法硕民法课程 60-90 分钟，作为第 1 个完整切片，听完做 5 题", "法理学第 13 章：错题回看、框架整理、第一轮背诵", "背诵：民法第 2 章第一轮", "整理民法第 1-3 章目录图"),
        daily("2026-07-25", "宪法1收口 + 法制史1收口", "宪法学第 1 章：听众合法硕宪法课程 45-60 分钟，补入口框架并做 5 题", "法制史第 1 章：听众合法硕法制史课程 45-60 分钟，补时间线并做 5 题", "背诵：宪法/法制史第 1 章关键词", "画两科第 1 章框架"),
        daily("2026-07-26", "刑法4第1切片 + 刑法3错题", "刑法学第 4 章：听众合法硕刑法课程 60-90 分钟，作为第 1 个切片，听完写 3 个关键词", "刑法第 3 章：错题回看 8 题，标出混淆点", "背诵：刑法第 2-3 章第一轮", "错题：刑法第 1-3 章挑 10 题"),
        daily("2026-07-27", "民法4第1切片 + 民法3错题", "民法第 4 章：听众合法硕民法课程 60-90 分钟，作为第 1 个切片，听完写 3 个关键词", "民法第 3 章：错题回看 8 题，标出混淆点", "背诵：民法第 2-3 章第一轮", "画民法第 3-4 章框架"),
        daily("2026-07-28", "阶段复盘日", "法理第 1-13 章目录背诵", "刑法第 1-4 章：统计已听分钟数、未闭环切片和最常错 10 题", "民法第 1-4 章：统计已听分钟数、未闭环切片和最常错 10 题", "整理 7 月错题清单和背诵清单"),
        daily("2026-07-29", "法理闭环 + 刑法4第2切片", "法理学第 1-13 章：列出最不会背的 20 个点", "刑法学第 4 章：听众合法硕刑法课程 60-90 分钟，作为第 2 个切片，听完补 5-8 题", "法理学第 11-13 章：第一轮背诵关键词", "背诵：法理第 8-10 章滚动", "画法理 13 章总框架"),
        daily("2026-07-30", "民法4第2切片 + 宪法2入口", "民法第 4 章：听众合法硕民法课程 60-90 分钟，作为第 2 个切片，听完补 5-8 题", "宪法学第 2 章：听众合法硕宪法课程 30-45 分钟，只抓入口", "背诵：刑法第 3-4 章第一轮关键词", "画宪法第 1-2 章框架"),
    ...
    fun todaySchedule(date: LocalDate = LocalDate.now()): List<StudyScheduleBlock> {
        ...
        if (date == LocalDate.of(2026, 7, 3)) {
            return listOf(
                ...
                StudyScheduleBlock("15:15-15:55", "刑法入口", "听众合法硕刑法课程第 1 章，作为约 6 小时课程的入口切片，只抓犯罪论总入口，听完写 3 个关键词。"),
                ...
                StudyScheduleBlock("19:30-20:10", "单词 3", "不背单词 40 个（2 组），完成今天英语最小闭环。"),
    ...
    fun dynamicSchedulePrompt(
        ...
        return buildString {
            ...
            appendLine("- 刑法、民法新章优先排 60-90 分钟听课切片 + 3-5 个关键词 + 5-8 题或小框架；恢复日才缩成 30-60 分钟入口切片。")
